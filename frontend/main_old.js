...
const App = {
    ...
    openPagoModal() {
        const modalPago = document.getElementById('modal-pago');
        const pagoLineas = document.getElementById('pago-lineas');
        const pagoTotal = document.getElementById('pago-total-amount');
        ...
        pagoLineas.innerHTML = lineas;
        pagoTotal.textContent = UI.formatearMoneda(AppState.tarifaSeleccionada.precio);

        // Configurar eventos del modal de pago
        this.setupPagoModalEvents();

        // Mostrar modal de pago
        modalPago.classList.remove('oculto');
        AppState.modalActivo = 'pago';
